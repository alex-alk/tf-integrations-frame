<?php $scripts['payment-plans'] = 'payment-plans.js' ?>
    ...
    <div class="container-fluid" style="padding-top: 20px;">
        <div class="row flex-xl-nowrap">
            ...
            <main class="col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">
                <h3 class="bd-title" id="content">Search - Payment plans</h3>
                <div>
                    <pre class="">Get payment policies.</pre>
                </div>
                <br>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select name="method">
                                        <option value="api_getOfferPaymentsPlan">api_getOfferPaymentsPlan</option>
                                    </select>
