<?php $scripts['countries'] = 'cancel-fees.js' ?>
    ...
    <div class="container-fluid" style="padding-top: 20px;">
        <div class="row flex-xl-nowrap">
            ...
            <main class="col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">
                <h3 class="bd-title" id="content">Search - Cancellation Fees</h3>
                <div>
                    <pre class="">Get cancellation fees.</pre>
                </div>
                <br>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select name="method">
                                        <option disabled="" value="api_getCountries">api_getCountries</option>
                                        ...
                                        <option value="api_getOfferCancelFees" selected="true">api_getOfferCancelFees</option>
                            ...
                            <tr>
                                <td>
                                    args[0][Hotel][InTourOperatorId]
                                </td>

                                <td>

                                    <input type="text" name="args[0][Hotel][InTourOperatorId]" value="">
                                </td>
                                <td>Hotel Id. </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="args[0][CheckIn]" value="">
                                </td>
                                <td>ex: 2023-05-01 </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="args[0][CheckOut]" value="">
                                </td>
                                <td>ex: 2023-05-02 </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    args[0][SuppliedPrice]
                                </td>

                                <td>

                                    <input type="text" name="args[0][SuppliedPrice]" value="">
                                </td>
                                <td> </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    args[0][SuppliedCurrency]
                                </td>

                                <td>

                                    <input type="text" name="args[0][SuppliedCurrency]">
                                </td>
                                <td> </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="args[0][Country]">
                                </td>
                                <td> </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="args[0][City]">
                                </td>
                                <td> </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="args[0][Duration]" value="">
                                </td>
                                <td> </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    args[0][OriginalOffer][Rooms][0][Id]
                                </td>

                                <td>

                                    <input type="text" name="args[0][OriginalOffer][Rooms][0][Id]" value="">
                                </td>
                                <td> </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    args[0][OriginalOffer][Code]
                                </td>

                                <td>

                                    <input type="text" name="args[0][OriginalOffer][Code]">
                                </td>
                                <td> </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    args[0][OriginalOffer][Gross]
                                </td>

                                <td>

                                    <input type="text" name="args[0][OriginalOffer][Gross]">
                                </td>
                                <td> </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    args[0][OriginalOffer][MealItem][Merch][Id]
                                </td>

                                <td>

                                    <input type="text" name="args[0][OriginalOffer][MealItem][Merch][Id]" value="">
                                </td>
                                <td> </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    args[0][OriginalOffer][InitialData]
                                </td>

                                <td>

                                    <input type="text" name="args[0][OriginalOffer][InitialData]">
                                </td>
                                <td> </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    args[0][OriginalOffer][bookingDataJson]
                                </td>

                                <td>

                                    <input type="text" name="args[0][OriginalOffer][bookingDataJson]" value="">
                                </td>
                                <td> </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    args[0][OriginalOffer][offerId]
                                </td>

                                <td>

                                    <input type="text" name="args[0][OriginalOffer][offerId]">
                                </td>
                                <td> </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    args[0][OriginalOffer][roomCombinationPriceDescription]
                                </td>

                                <td>

                                    <input type="text" name="args[0][OriginalOffer][roomCombinationPriceDescription]">
                                </td>
                                <td> </td>
                            </tr>
