    ...
    <div class="container-fluid" style="padding-top: 20px;">
        <div class="row flex-xl-nowrap">
            ...
            <main class="col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">
                <h3 class="bd-title" id="content">Geography - Regions</h3>
                <div>
                    <pre class="">This service provides the list of all the regions.</pre>
                </div>
                <br>
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="method">
                                        <option value="api_getRegions">api_getRegions</option>
                                    </select>
                                </td>
                                <td> </td>
                            </tr>
