jQuery(document).ready(function() {
    ...
    if ($softwareSelect[0] !== undefined) {
        ...
        if (isLocal) {
            ...
            infiniteMap.set('localhost-infinitehotel', $url + folder + '/test-infinitehotel');
            cyberlogicMap.set('localhost-filos', $url + folder + '/test-cyberlogic');
            h2bMap.set('localhost-h2b', $url + folder + '/test-h2b/');
            alladynHotelsMap.set('localhost-tez', $url + folder + '/test-alladyn/agent');
            alladynChartersMap.set('localhost-tezc', $url + folder + '/test-alladyn/agent');
            apitudeMap.set('localhost-hotelbeds', $url + folder + '/test-apitude');
            euroSiteMap.set('localhost-eximtur', $url + folder + '/test-eurosite/server_xml/server.php');
            amaraMap.set('localhost-amara_v2', $url + folder + '/test-amara_v2');
            etripAgencyMap.set('localhost-eagency', $url + folder + '/test-etrip-agency');
            brosTravelMap.set('localhost-bros', $url + folder + '/test-brostravel');
            odeonTravelMap.set('localhost-coral', $url + folder + '/test-coraltravel');
            dertourMap.set('localhost-dertour', $url + folder + '/test-dertour');
            tourVisioV2Map.set('localhost-fibula_v2', $url + folder + '/test-fibula_v2');
            etripMap.set('localhost-holidayoffice', $url + folder + '/test-holidayoffice')
                .set('<?php echo TestHandles::LOCALHOST_HOLIDAYOFFICE_TOUR_ONLY ?>', $url + folder + '/test-holidayoffice');;
            megatecMap.set('localhost-solvex', $url + folder + '/test-solvex');
            travelioV2Map.set('localhost-karpaten_v2', $url + folder + '/test-karpaten_v2');
            teztourv2Map.set('localhost-teztour_v2', $url + folder + '/test-teztour_v2');
            sansejourMap.set('localhost-clubmagellan', $url + folder + '/test-clubmagellan');
            samoMap.set('localhost-prestige', $url + folder + '/test-prestige');
            tboMap.set('localhost-tbo', $url + folder + '/test-tbo');
            sphinxMap.set('localhost-sphinx', $url + folder + '/test-sphinx');
        }
        ...
        const credentialsJson = <?php echo getCredentialsMapJson() ?>;
