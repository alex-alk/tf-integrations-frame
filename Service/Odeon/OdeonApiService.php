...
class OdeonApiService extends AbstractApiService
{
    ...
    public function __construct(protected ServerRequestInterface $serverRequest, private HttpClient $client)
    {
    ...
    //     $this->client = Request::create();
    //     $responseDepObj = $this->client->request(Request::METHOD_POST, $this->apiUrl, $options);
    ...
    //             $responseDep = json_decode($responseDepObj->getBody(), true);
    //         }
    //         // $this->showRequest(Request::METHOD_POST, $this->apiUrl, $options, $responseDepObj->getBody(), $responseDepObj->getStatusCode());
    ...
    //                     $options['body'] = json_encode($requestArr);
    //                     $responseObj = $this->client->request(Request::METHOD_POST, $this->apiUrl, $options);
    ...
    private function cacheToken(): string
    {
        ...
        $responseObj = $this->client->request(Request::METHOD_POST, $this->apiUrl, $bodyLogin, $headers);
        $this->showRequest(Request::METHOD_POST, $this->apiUrl, $bodyLogin, $headers, $responseObj->getBody(), $responseObj->getStatusCode());
        $response = json_decode($responseObj->getBody(), true);
    ...
    //             $responseData = json_decode($responseObj->getBody(), true);
    //         }
    //         $this->showRequest(Request::METHOD_POST, $this->apiUrl, $options, $responseObj->getBody(), $responseObj->getStatusCode());
    ...
    //     $responseObj = $this->client->request(Request::METHOD_GET, $url);
    //     $this->showRequest(Request::METHOD_GET, $url, [], $responseObj->getBody(), $responseObj->getStatusCode());
    ...
    //     $responseInfo = $this->client->request(Request::METHOD_GET, $hotelUrl);
    ...
    //     $this->client = Request::create(['max_duration' => 120]);
    ...
    //         $options['body'] = json_encode($requestArr);
    //         $responseObject = $this->client->request(Request::METHOD_POST, $this->apiUrl, $options);
    ...
    //                 $this->showRequest(Request::METHOD_POST, $this->apiUrl, $optionsResp, $responseObj->getBody(), $responseObj->getStatusCode());
    //                 $responseData = json_decode($responseObj->getBody(), true);
    ...
    //                             break;
    //                         }
    //                         $responseObj = $this->client->request(Request::METHOD_POST, $this->apiUrl, $optionsResp);
    ...
    //     $responseObj = $this->client->request(Request::METHOD_POST, $this->apiUrl, $optionsFlight);
    //     $response = json_decode($responseObj->getBody(), true);
    ...
    //         $response = json_decode($responseObj->getBody(), true);
    //     }
    //     $this->showRequest(Request::METHOD_POST, $this->apiUrl, $optionsFlight, $responseObj->getBody(), $responseObj->getStatusCode());
    ...
    //     $responseObj = $this->client->request(Request::METHOD_POST, $this->apiUrl, $optionsLogin);
    //     $this->showRequest(Request::METHOD_POST, $this->apiUrl, $optionsLogin, $responseObj->getBody(), $responseObj->getStatusCode());
    //     $response = json_decode($responseObj->getBody(), true);
